...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  void _processPayment() async {
    ...
    // Get the selected ticket type ID
    ...
    try {
      // Create the CreateTicketDto object
      Createticketdto newTicket = Createticketdto(
        id: 0, // This might be auto-generated by the backend
      ...
      if (response.statusCode >= 200 && response.statusCode <= 299) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Payment successful! Your tickets have been booked.'),
